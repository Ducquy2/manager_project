		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="box box-info">
					...
					<div class="box-body">
						<form:form action="/getfeedback/${feedback.id}/feedack"
							method="post" modelAttribute="feedback">
							<div class="form-group">
								<form:input type="email" class="form-control" name="emailto"
									path="email" placeholder="Email to:" />
							</div>
							<div class="form-group">
							...
							<div class="box-footer clearfix">
								...
								<a type="button" class="pull-left btn btn-warning"
									href="/getfeedback" id="cancel"
									onclick="return confirm('Bạn chắc chắn muốn ngừng thực hiện tác vụ không ?')"> Cancel <i
