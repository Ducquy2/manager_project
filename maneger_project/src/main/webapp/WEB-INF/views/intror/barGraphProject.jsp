				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h1 style="margin-left: 30%; color: blue">Bảng Thông tin Log Project Tiến Độ</h1>
						</div>
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach items="${projectprogress}" var="projectprogress"
										varStatus="s">
										<tr>
											<td><c:out value="${s.index + 1}" /></td>
											<td><c:out value="${projectprogress.dateLog}" /></td>
											<td><c:out value="${projectprogress.progress}" />%</td>
											<td><c:out value="${projectprogress.detailLog}" /></td>
											<td><c:out value="${projectprogress.projectId.projectId}" /></td>
											<td><c:out value="${projectprogress.projectId.projectName}" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<aside class="control-sidebar control-sidebar-dark">
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="control-sidebar-home-tab">
				...
				<h3 class="control-sidebar-heading">Project Progress</h3>
				<ul class="control-sidebar-menu">
