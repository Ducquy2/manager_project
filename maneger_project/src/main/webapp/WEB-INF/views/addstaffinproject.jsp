	...
	<!-- Logo -->
			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<a href="#" class="sidebar-toggle" data-toggle="offcanvas"
					role="button"> <span class="sr-only">Chuyển đổi điều hướng</span>
				</a>
				<!-- Navbar Right Menu -->
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown tasks-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="footer"><a href="#">Xem tất cả các nhiệm vụs</a></li>
							</ul>
						</li>
						<!-- User Account Menu -->
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img src="images/user.png"
									...
									<p>
										${username} - Web Developer <small>Thành viên từ tháng 3 năm 2025</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
									<div class="row">
									...
									<div class="pull-right">
										<form action="/logout" method="get">
											<button class="btn btn-md btn-danger btn-block"
												name="registration" type="Submit">Đăng xuất</button>
										</form>
									</div>
								</li>
							</ul>
				...
				<div class="container">
					...
					<table class="table table-striped">
						<tbody>
							<tr>
								<td colspan="1">
									<h2>THÊM NHÂN VIÊN VÀO DỰ ÁN CÓ TÊN :
											...
											<c:choose>
												<c:when test="${not empty staff }">
													<div class="form-group">
														<label class="col-md-2 control-label">Chọn nhân viên<span
													...
													<div class="text-center">
														<button type="submit" class="btn btn-primary">Thêm nhân viên vào dự án</button>
														<a type="button" class="btn btn-primary"
															href="/project/${project.projectId}/staff"
															onclick="return confirm('Bạn chắc chắn muốn ngừng thực hiện tác vụ không ?')">Hủy bỏ</a>
													</div>
												</c:when>
												<c:otherwise>
