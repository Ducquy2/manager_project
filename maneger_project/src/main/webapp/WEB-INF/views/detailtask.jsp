				...
				<div class="row">
					...
					<div class=" col-sm-6 ">
						<div class="info-box">
							...
							<div class="info-box-content">
								<span class="info-box-text">Name Assign</span> 
								
								<c:choose>
                                     <c:when test="${not empty task.staffId }">
                                     <span class="info-box-number">${task.staffId.fullName}</span>
                                     </c:when>
                                     <c:otherwise>
                                     <span class="info-box-number">chưa assign task</span>
                                     </c:otherwise>
                                </c:choose>
					...
					<div class="col-sm-6">
						<div class="info-box">
							...
							<div class="info-box-content">
								...
								<c:choose>
									<c:when test="${not empty task.finishDate }">
									<span class="info-box-number">${task.finishDate}</span>
									</c:when>
									<c:otherwise>
									<span class="info-box-number">Chưa có ngày kết thúc thực tế</span>
									</c:otherwise>
								</c:choose>
					...
					<div class="col-md-6">
						<div class="info-box">
							<span class="info-box-icon bg-maroon"><i
								class="fa fa-address-book"></i></span>
							<div class="info-box-content">
								<span class="info-box-text">Task output</span> 
								<c:choose>
									<c:when test="${not empty task.taskOutput}">
										<span class="info-box-number">${task.taskOutput}</span>
									</c:when>
									<c:otherwise>
										<span class="info-box-number">chưa có thư mục output đầu ra</span>
									</c:otherwise>
								</c:choose>
