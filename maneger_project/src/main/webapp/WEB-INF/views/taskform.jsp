                                ...
                                <div class="pull-right">
                                    <form action="/logout" method="get">
                                        <button class="btn btn-md btn-danger btn-block"
                                                name="registration" type="Submit">Logout
                                        </button>
                                    </form>
                                </div>
                            </li>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><spring:url value="/aboutapp" var="listURL"/>
                    <a class="" href="${listURL}"><i
                            class="glyphicon glyphicon-info-sign"></i> <span>Quản lý phản hồi</span></a></li>

                <li class="active"><spring:url value="/aboutteam"
                                               var="listURL"/> <a class="" href="${listURL}"><i
                        class="glyphicon glyphicon-camera"></i> <span>Giới thiệu về Web</span></a></li>
                            ...
                            <fieldset>
                                <form:form modelAttribute="task" method="POST"
                                            ...
                                            <div class="col-md-8 inputGroupContainer">
                                                <div class="input-group">
                                                    ...
                                                    <form:select path="previousTask" class="form-control" >
                                                    	 <form:option value="" label="--- Task cần làm trước ---"/>
                                    ...
                                    <div id="taskInfo">
                                        ...
                                        <form:input type="hidden" path="taskIdparent"
                                                    value="${task.taskIdparent}"></form:input>
                                        ...
                                        <div class="text-center">
                                         ...
                                         <a type="button" class="btn btn-primary" href="/project/${task.projectId.projectId}/task"
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="control-sidebar-settings-tab">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading"> Báo cáo sử dụng bảng điều khiển <input type="checkbox" class="pull-right" checked>
                        </label>
